 classdef metricsVisualizer < handle
    ...
    properties
        ...
        % plots. By default the plots are disabled
        EnableSchedulerMetricsPlots = true
   ...
   properties(Access = private, Hidden)
    ...
    methods (Access = public)
        function obj = metricsVisualizer(param, varargin)
            %nrMetricsVisualizer Constructs metrics visualization object
            %
            % OBJ = nrMetricsVisualizer(PARAM) Create metrics visualization
            % object for downlink and uplink plots.
            %
            % OBJ = nrMetricsVisualizer(PARAM, Name, Value) creates a metrics visualization
        ...
        function results = saveMetrics(obj)
