function rxWaveform = basicRadarChannel(txWaveform, radarParams)
...
% Ministry of Education, BUPT.
    ...
    % Range parameters
    pathDelay = 2.*radarParams.range./c;  % echo delay

    % Velocity parameters
    fd = 2.*radarParams.velocity./lambda; % echo doppler shift
