...
% cellSimuParams: cell simulation pararmeters 
    ...
    cellSimuParams.gNBRxPanel      = bsParams.txAntenna.arrayGeometry;
    ...
    cellSimuParams.numTargets     = targetParams.numTargets;
    cellSimuParams.targetPosition = targetParams.position;
    cellSimuParams.rcs            = targetParams.rcs;
    cellSimuParams.velocity       = targetParams.velocity;
